...
namespace LogsAnalyzer.Tests {
    ...
    public class LogReaderTests {
        ...
        public void itShouldCallBeginReadAllOfAnalyzersBeforeReadingLogs() {
            var mockAnalyzer = new MockAnalyzer<BaseAnalysisResult>();
        ...
        public void itShouldSupportMultipleAnalyzers() {
            var mockAnalyzer1 = new MockAnalyzer<BaseAnalysisResult>();
            var mockAnalyzer2 = new MockAnalyzer<BaseAnalysisResult>();
        ...
        public void itShouldHandleExceptionInBeginReadAll() {
            var mockAnalyzer = new MockAnalyzerThrowingException<BaseAnalysisResult>();
            var analyzers = new List<BaseLogAnalyzer<BaseAnalysisResult>>();
            analyzers.Add(mockAnalyzer);
            var logReader = new LogReader(analyzers);
